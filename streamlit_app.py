...
# ==================================================
# --- 3. INTERFACE E VITRINE (BLINDADA) ---
# ==================================================
...
for i in range(7):
    ...
    # Usando blocos separados para facilitar a leitura e não quebrar no celular
    bloco = f"""
...
# O truque de mestre: apaga qualquer quebra de linha acidental antes de desenhar na tela!
